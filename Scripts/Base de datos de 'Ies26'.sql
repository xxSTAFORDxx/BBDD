drop database if exists ies26;
create database ies26;
use ies26;
...
hores_cicles int default 2000
);

insert into cicles values 
('DAM', 'Desenvolupament Aplicacions Informàtiques', 'S', 2000),
('DAMVI', 'Desenvolupament Aplicacions Informàtiques Video Jocs', 'S', 2000),
...
nom_modul varchar(60) not null,
hores_modul int check(hores_modul >=1),
...
insert into moduls (id_cicle, codi_modul, nom_modul, hores_modul, curs_modul) values 
				   ...
				   ('DAM', 'M0484', 'Base de Dades', 132, 1),
				   ('DAM', 'M0485', 'Programació', 198, 1),
				   ('DAM', 'M0487', 'Entorns', 66, 1),
				   ('DAM', 'M0473', 'WEB', 66, 1),
				   ('DAM', 'M0179', 'Angles', 99, 1),
...
create or replace table assignacions (
...
create or replace table empreses (
...
create or replace table convenis (
...
create or replace table substitucions (
